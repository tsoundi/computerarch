...
_int64 version_vectorization(int n, short* arr, short* arr2, short* result) {
	...
	for (int i = 0; i < n; i += 16) {
		...
		/*
		result[i] = _mm256_extract_epi16(res, 0);
		result[i + 1] = _mm256_extract_epi16(res, 1);
		result[i + 2] = _mm256_extract_epi16(res, 2);
		result[i + 3] = _mm256_extract_epi16(res, 3);
		result[i + 4] = _mm256_extract_epi16(res, 4);
		result[i + 5] = _mm256_extract_epi16(res, 5);
		result[i + 6] = _mm256_extract_epi16(res, 6);
		result[i + 7] = _mm256_extract_epi16(res, 7);
		result[i + 8] = _mm256_extract_epi16(res, 8);
		result[i + 9] = _mm256_extract_epi16(res, 9);
		result[i + 10] = _mm256_extract_epi16(res, 10);
		result[i + 11] = _mm256_extract_epi16(res, 11);
		result[i + 12] = _mm256_extract_epi16(res, 12);
		result[i + 13] = _mm256_extract_epi16(res, 13);
		result[i + 14] = _mm256_extract_epi16(res, 14);
		result[i + 15] = _mm256_extract_epi16(res, 15);
		*/
