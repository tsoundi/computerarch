...
#define N 1024 * 1024 // size of the arrays
...
_int64 sequential_version(const int n, short* arr, short* arr2, short* result);
_int64 version_constant_size(int n, short* arr, short* arr2, short* result);


_int64 version_PragmaUnrollInner(int n, short* arr, short* arr2, short* result);
...
// utility functions
void checkIfResultsAreTheSame(string name, short* arr3, short* arr4, int n);
...
int main(int argc, char *argv[])
{
	...
	short* arr = new short[N], *arr2 = new short[N]; // input array
	short* arr3 = new short[N]; // result of sequential version (the truth)
	short* arr4 = new short[N]; // results of the alternative versions (will be compared with the truth)
	for (int i = 0; i < N; i++) {
		arr[i] = rand();
		arr2[i] = rand();
...
//  ==== ALL VERSIONS ====
_int64 sequential_version(int n, short* arr, short* arr2, short* result) {
